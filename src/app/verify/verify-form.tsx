...
export function VerifyForm({ mockEnabled }: { mockEnabled: boolean }) {
  ...
  return (
    ...
    >
      {mockEnabled && (
        <div className="rounded bg-destructive/10 px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide text-destructive">
          Dev-only mock — no real SMS sent, use code {`123456`}
        </div>
      )}
